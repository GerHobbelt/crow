...
namespace crow // NOTE: Already documented in "crow/app.h"
{
    ...
    public:
        ...
        {
            max_payload_ = max_payload_override_ ? max_payload_ : app_->websocket_max_payload();
            new crow::websocket::Connection<UnixSocketAdaptor, App>(req, std::move(adaptor), app_, max_payload_, subprotocols_, open_handler_, message_handler_, close_handler_, error_handler_, timeout_handler_, accept_handler_, mirror_protocols_);
        }
#ifdef CROW_ENABLE_SSL
