...
namespace crow
{
    ...
    public:
        ...
        {
            new crow::websocket::Connection<SocketAdaptor, App>(req, std::move(adaptor), app_, websocket_count, open_handler_, message_handler_, close_handler_, error_handler_, accept_handler_);
        }
#ifdef CROW_ENABLE_SSL
